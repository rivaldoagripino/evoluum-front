...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    evoluumFrontAuthUserSubject.add(
      EvoluumFrontAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<EvoluumFrontAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  EvoluumFrontAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = EvoluumFrontAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    evoluumFrontAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
EvoluumFrontAuthUser? currentUser;
